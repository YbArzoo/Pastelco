...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-dark navbar-dark shadow-sm py-3 py-lg-0 px-3 px-lg-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto mx-lg-auto py-0">
                <!--<a href="index.php" class="nav-item nav-link active">Back to Home Page</a>-->
                <a href="order_list_rider.php" class="nav-item nav-link">My Orders</a>
                <a href="confirm.php" class="nav-item nav-link">Hand Over</a>
                <a href="my_account.php" class="nav-item nav-link">My Info</a>
    ...
    <div class=" container-fluid pt-5">
        <div class="section-title position-relative text-center mx-auto mb-5 pb-3" style="max-width: 600px;">
            <h1 class="display-4 text-uppercase">Welcome To Rider's Panel</h1>
        </div>
    </div>
    <!-- Admin panel end -->
