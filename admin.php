...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-dark navbar-dark shadow-sm py-3 py-lg-0 px-3 px-lg-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto mx-lg-auto py-0">
                <a href="index.html" class="nav-item nav-link active">Back to Home Page</a>
    ...
    <div class=" container-fluid pt-5">
        <div class="section-title position-relative text-center mx-auto mb-5 pb-3" style="max-width: 600px;">
            <h1 class="display-4 text-uppercase">Welcome To Admin Panel</h1>
        </div>
    </div>

    <!-- ADD FLAVOUR FROSTING TOPPINGS BEVERAGES START  -->
    <div class="container-fluid service position-relative px-5 mt-5" style="margin-bottom: 135px;">
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-4 col-md-6">
                    <div class="bg-primary border-inner text-center text-white p-5">
                        <h4 class="text-uppercase mb-3">Add Flavours</h4>
                        <a href="add_flavours.php" class="btn btn-dark border-inner py-3 px-5">Add</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="bg-primary border-inner text-center text-white p-5">
                        <h4 class="text-uppercase mb-3">Add Frosting</h4>
                        <a href="add_frosting.php" class="btn btn-dark border-inner py-3 px-5">Add</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="bg-primary border-inner text-center text-white p-5">
                        <h4 class="text-uppercase mb-3">Add Toppings</h4>
                        <a href="add_toppings.php" class="btn btn-dark border-inner py-3 px-5">Add</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="bg-primary border-inner text-center text-white p-5">
                        <h4 class="text-uppercase mb-3">Add Beverages</h4>
                        <a href="add_beverages.php" class="btn btn-dark border-inner py-3 px-5">Add</a>
                    </div>
                </div>
            </div>
        </div>
