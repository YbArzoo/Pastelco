...
if(isset($_POST['select'])){
    ...
    $query1="update forward_order set rider_id=:rider_id where cart_id=:cart_id";
    $arr1=array(
    ...
    echo "<script>window.location.href='http://localhost/pastelco/order_list_rider.php'</script>";
}
    ...
    <nav class="navbar navbar-expand-lg bg-dark navbar-dark shadow-sm py-3 py-lg-0 px-3 px-lg-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto mx-lg-auto py-0">
                ...
                <a href="login.php" class="btn btn-square-login">Login</a>
                        ...
                        <div class="row g-3">
                            ...
                            <?php foreach ($rows as $row): ?>   
                                ...
                                <h5 class="text-uppercase"><?php echo $new_row["cart_id"]; ?></h5>
                                                ...
                                                <form action="order_list_rider.php" method="POST">
                                                    <button name="select" value="<?php echo $new_row['cart_id'];?>" class="btn btn-primary w-100 py-3" type="submit">select</button>
                                                </form>
                                            </div>
                                        </div>
                                </div>
